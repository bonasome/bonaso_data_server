...
from respondents.models import Respondent, Interaction, Pregnancy, HIVStatus, KeyPopulation, DisabilityType, InteractionSubcategory, RespondentAttribute, RespondentAttributeType
...
class RespondentSerializer(serializers.ModelSerializer):
    ...
    def validate_required_attribute_names(self, value):
        ...
        for name in value:
            ...
            if name in auto_choices:
                print('WARNING: This field should be autogenerated and not manually set by the user.')
            else:
                cleaned.append(name)
    ...
    def create(self, validated_data):
        ...
        for name in special_attribute_names:
            attr_type = RespondentAttributeType.objects.get_or_create(name=name)
