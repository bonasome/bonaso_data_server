...
class UploadViewSetTest(APITestCase):
    ...
    def test_upload_respondents(self):
        ...
        headers = [
            ...
            "District", "Citizenship/Nationality", "Email Address", "Phone Number", "Key Population Status",
            "Disability Status", "Date of Interaction", "TEST1: Parent Indicator", "TEST2: Child Indicator", "Comments"
        ]
        ws.append(headers)
        #ideal upload
        row = [
            ...
            "Hearing Impaired, Visually Impaired", date(2024, 5, 1), "Yes", "Yes", ""
        ]
        ws.append(row)
        ...
        row2 = [
            ...
            "hearing   Impaired; Visually Impaired", '45447', "Yes", "Yes", ""
        ]
        ws.append(row2)
        #test anon
        row3 = [
            "TRUE", "", "", "", "Under 18", "", "Male", "", "Testington",
            "Central District", "Motswana", "", "", "", 
            "", date(2024, 5, 1), "Yes", "Yes", ""
        ]
        ws.append(row3)
    ...
    def test_bad_interaction_date(self):
        ...
        row = [
            ...
            "Central District", "Motswana", "test@website.com", "71234567", "Transgender, Intersex", 
            "Hearing Impaired, Visually Impaired", date(2000, 5, 1), "Yes", "Yes", ""
        ]
        ws.append(row)
    ...
    def test_upload_interactions(self):
        ...
        row = [
            "FALSE", "T1", "Test", "Testerson", "", date(1990, 5, 1), "Male", "Wardplace", "Testington",
            "Central District", "Motswana", "test@website.com", "71234567", "Transgender, Intersex", 
            "Hearing Impaired, Visually Impaired", date(2024, 5, 1), "Yes", "", ""
        ]
        ws.append(row)
    ...
    def test_upload_interactions_no_prereq(self):
        ...
        row = [
            "FALSE", "T1", "Test", "Testerson", "", date(1990, 5, 1), "Male", "Wardplace", "Testington",
            "Central District", "Motswana", "test@website.com", "71234567", "Transgender, Intersex", 
            "Hearing Impaired, Visually Impaired", date(2024, 5, 1), "No", "Yes", ""
        ]
        ws.append(row)
    ...
    def test_numeric(self):
        ...
        headers = [
            "Is Anonymous","ID/Passport Number","First Name" , "Last Name", "Age Range", "Date of Birth", "Sex", "Ward", "Village",
            "District", "Citizenship/Nationality", "Email Address", "Phone Number", "Key Population Status",
            "Disability Status", "Date of Interaction", "NUM: Number (Requires a Number)", "Comments"
        ]
        ws.append(headers)
        #this is fine
        row = [
            "FALSE", "T1", "Test", "Testerson", "", date(1990, 5, 1), "Male", "Wardplace", "Testington",
            "Central District", "Motswana", "test@website.com", "71234567", "Transgender, Intersex", 
            "Hearing Impaired, Visually Impaired", date(2024, 5, 1), "6", ""
        ]
        ws.append(row)
    ...
    def test_subcats_valid(self):
        ...
        headers = [
            "Is Anonymous","ID/Passport Number","First Name" , "Last Name", "Age Range", "Date of Birth", "Sex", "Ward", "Village",
            "District", "Citizenship/Nationality", "Email Address", "Phone Number", "Key Population Status",
            "Disability Status", "Date of Interaction", "SC: Subcat", "Comments"
        ]
        ws.append(headers)
        #this is fine
        row = [
            "FALSE", "T1", "Test", "Testerson", "", date(1990, 5, 1), "Male", "Wardplace", "Testington",
            "Central District", "Motswana", "test@website.com", "71234567", "Transgender, Intersex", 
            "Hearing Impaired, Visually Impaired", date(2024, 5, 1), "Cat 1", ""
        ]
        ws.append(row)
        #should also work
        row2 = [
            ...
            "Central District", "Motswana", "test@website.com", "71234567", "Transgender, Intersex", 
            "Hearing Impaired, Visually Impaired", date(2024, 5, 1), "cat2;Cat1  ", ""
        ]
        ws.append(row2)
    ...
    def test_subcats_invalid_missing(self):
        ...
        row = [
            "FALSE", "T1", "Test", "Testerson", "", date(1990, 5, 1), "Male", "Wardplace", "Testington",
            "Central District", "Motswana", "test@website.com", "71234567", "Transgender, Intersex", 
            "Hearing Impaired, Visually Impaired", date(2024, 5, 1), "", ""
        ]
        ws.append(row)
        #forgot the comma
        row2 = [
            "FALSE", "T2", "Test", "Testerson", "", date(1990, 5, 1), "Male", "Wardplace", "Testington",
            "Central District", "Motswana", "test@website.com", "71234567", "Transgender, Intersex", 
            "Hearing Impaired, Visually Impaired", date(2024, 5, 1), "cat1Cat1  ", ""
        ]
        ws.append(row2)
    ...
    def test_upload_mismatched_subcat(self):
        ...
        headers = [
            "Is Anonymous","ID/Passport Number","First Name" , "Last Name", "Age Range", "Date of Birth", "Sex", "Ward", "Village",
            "District", "Citizenship/Nationality", "Email Address", "Phone Number", "Key Population Status",
            "Disability Status", "Date of Interaction", "PSC: Subcat Parent", "CSC: Subcat Child", "Comments"
        ]
        ws.append(headers)
        row = [
            "FALSE", "T1", "Test", "Testerson", "", date(1990, 5, 1), "Male", "Wardplace", "Testington",
            "Central District", "Motswana", "test@website.com", "71234567", "Transgender, Intersex", 
            "Hearing Impaired, Visually Impaired", date(2024, 5, 1), "Cat 1", "Cat 1, Cat 2", ""
        ]
        ws.append(row)
    ...
    def test_upload_matched_subcat(self):
        ...
        row = [
            "FALSE", "T1", "Test", "Testerson", "", date(1990, 5, 1), "Male", "Wardplace", "Testington",
            "Central District", "Motswana", "test@website.com", "71234567", "Transgender, Intersex", 
            "Hearing Impaired, Visually Impaired", date(2024, 5, 1), "Cat 1", "Cat 1", ""
        ]
        ws.append(row)
