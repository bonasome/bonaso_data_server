...
class User(AbstractUser):
    ...
    role = models.CharField(max_length=25, choices=Role.choices, default=Role.DATA_COLLECTOR, help_text='Set user access level and permission. Leave as "Data Collector" if unsure.')
    def __str__(self):
